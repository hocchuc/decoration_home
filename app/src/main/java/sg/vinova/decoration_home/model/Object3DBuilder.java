package sg.vinova.decoration_home.model;
...
import sg.vinova.decoration_home.services.WavefrontLoader.FaceMaterials;
import sg.vinova.decoration_home.services.WavefrontLoader.Faces;
import sg.vinova.decoration_home.services.WavefrontLoader.Material;
import sg.vinova.decoration_home.services.WavefrontLoader.Materials;
import sg.vinova.decoration_home.services.WavefrontLoader.Tuple3;
import sg.vinova.decoration_home.services.collada.loader.ColladaLoader;
import sg.vinova.decoration_home.services.stl.STLLoader;
import sg.vinova.decoration_home.services.wavefront.WavefrontLoader2;
import sg.vinova.decoration_home.util.math.Math3DUtils;
...
class BoundingBox {
	 ...
	 */
	public BoundingBox(sg.vinova.decoration_home.entities.BoundingBox box, float[] color) {
		// initialize vertex byte buffer for shape coordinates
	...
	private void calculateVertex(sg.vinova.decoration_home.entities.BoundingBox box) {
		//@formatter:off
